...
type SitesStatusController struct {
	beego.Controller
}
...
// @router / [post]
func (o *SitesStatusController) Post() {
	/*
...
// @router /:objectId [get]
func (o *SitesStatusController) Get() {
...
// @Failure 403 :objectId is empty
// @router / [get]
func (o *SitesStatusController) GetAll() {
	/*
		obs := models.GetAll()
		o.Data["json"] = obs
		o.ServeJson()
...
// @Failure 403 :objectId is empty
// @router /:objectId [put]
func (o *SitesStatusController) Put() {
...
func (o *SitesStatusController) Delete() {
	objectId := o.Ctx.Input.Params[":objectId"]
