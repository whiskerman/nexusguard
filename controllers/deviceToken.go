...
// @router / [post]
func (o *DeviceTokenController) Post() {
	/*
...
// @router /:objectId [get]
func (o *DeviceTokenController) Get() {
...
// @Failure 403 :objectId is empty
// @router / [get]
func (o *DeviceTokenController) GetAll() {
	/*
		obs := models.GetAll()
		o.Data["json"] = obs
		o.ServeJson()
...
// @Failure 403 :objectId is empty
// @router /:objectId [put]
func (o *DeviceTokenController) Put() {
...
func (o *DeviceTokenController) Delete() {
	objectId := o.Ctx.Input.Params[":objectId"]
