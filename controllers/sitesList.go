...
type SitesListController struct {
	beego.Controller
}
...
// @router / [post]
func (o *SitesListController) Post() {
	/*
...
// @router /:objectId [get]
func (o *SitesListController) Get() {
...
// @Failure 403 :objectId is empty
// @router / [get]
func (o *SitesListController) GetAll() {
	/*
		obs := models.GetAll()
		o.Data["json"] = obs
		o.ServeJson()
...
// @Failure 403 :objectId is empty
// @router /:objectId [put]
func (o *SitesListController) Put() {
...
func (o *SitesListController) Delete() {
	objectId := o.Ctx.Input.Params[":objectId"]
